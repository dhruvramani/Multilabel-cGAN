...
input_dim, random_dim, output_dim = 1001, 100, 53
...
def generator_model():
    ...
    layer1 = Dense(680, input_dim = input_dim + random_dim, activation='relu')(start)
    ...
    layer4 = Dense(output_dim, activation='sigmoid')(layer3)
    model = Model(input=[noise, x], output=layer4)
    return model
...
def train():
    ...
    for epoch in range(num_epoch):
        ...
        for index in range(num_batches):
            ...
            fake_y = generator.predict([x_batch])
